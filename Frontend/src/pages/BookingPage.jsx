...
const BookingPage = () => {
  ...
  // Update name if user data loads after initial render
  useEffect(() => {
    if (user?.name) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4">
        <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] text-center animate-in fade-in zoom-in duration-500">
          ...
          <p className="mt-4 text-gray-500 leading-relaxed">
            Great choice, **{user?.name || "Customer"}**! We've secured your
            slot. A confirmation has been sent to your email.
          </p>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-gray-600 italic">
            Experience top-tier service at your doorstep.
          </p>
        </div>
          ...
          <div className="p-8 sm:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  <label className="flex items-center text-sm font-semibold text-gray-700 ml-1">
                    <Phone className="w-4 h-4 mr-2 text-blue-500" /> Contact
                    Number
                  </label>
                  <input
                    type="tel"
                ...
                <div className="space-y-2">
                  <label className="flex items-center text-sm font-semibold text-gray-700 ml-1">
                    <Building2 className="w-4 h-4 mr-2 text-blue-500" /> Project
                    Type
                  </label>
                  <select
                    name="projectType"
                ...
                <div className="space-y-2">
                  <label className="flex items-center text-sm font-semibold text-gray-700 ml-1">
                    <Wallet className="w-4 h-4 mr-2 text-blue-500" /> Estimated
                    Budget
                  </label>
                  <select
                    name="budget"
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="flex items-center text-sm font-semibold text-gray-700 ml-1">
                    <MapPin className="w-4 h-4 mr-2 text-blue-500" /> Service
                    Location
                  </label>
                  <textarea
                    name="address"
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="flex items-center text-sm font-semibold text-gray-700 ml-1">
                    <Notebook className="w-4 h-4 mr-2 text-blue-500" /> Special
